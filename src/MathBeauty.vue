...
const effectPresetGroups: Record<string, Partial<MathBeautyProps>[]> = {
  ...
  'tan-radial-web': [
    ...
    {
      tanRadialWebFrequency: 0.46,
      tanRadialWebGuard: 0.004,
      tanRadialWebClamp: 16,
      animationSpeed: 0.2,
      lineWidth: 2.6,
      lineColor: '#f43f5e',
      showTrail: true,
    ...
    {
      tanRadialWebFrequency: 0.34,
      tanRadialWebGuard: 0.008,
      tanRadialWebClamp: 8,
      animationSpeed: 0.24,
      lineWidth: 2.8,
      lineColor: '#e11d48',
  ...
  'sin-cos-oval-weave': [
    ...
    {
      ovalWeaveXSinAmp: 2.4,
      ovalWeaveXCosAmp: 0.9,
      ovalWeaveXCosFreq: 3.4,
      ovalWeaveYCosAmp: 2.2,
      animationSpeed: 0.2,
      lineWidth: 2.6,
      lineColor: '#06b6d4',
      showTrail: true,
    ...
    {
      ovalWeaveXSinAmp: 1.7,
      ovalWeaveXCosAmp: 1.2,
      ovalWeaveXCosFreq: 2.2,
      ovalWeaveYCosAmp: 2.6,
      animationSpeed: 0.22,
      lineWidth: 2.8,
      lineColor: '#0891b2',
      showTrail: true,
  ...
  'vortex-spiral': [
    ...
    {
      vortexSpiralTurns: 9.2,
      vortexSpiralCurl: 1.85,
      vortexSpiralDrift: 0.04,
      vortexSpiralWave: 1.35,
      vortexSpiralScale: 7.1,
      animationSpeed: 0.2,
      lineWidth: 2.6,
      lineColor: '#a855f7',
      showTrail: true,
    ...
    {
      vortexSpiralTurns: 14.6,
      vortexSpiralCurl: 0.68,
      vortexSpiralDrift: 0.1,
      vortexSpiralWave: 0.4,
      vortexSpiralScale: 5.5,
      animationSpeed: 0.22,
      lineWidth: 2.8,
      lineColor: '#f472b6',
      showTrail: true,
  ...
  'particle-flow-weave': [
    ...
    {
      particleFlowDensity: 60,
      particleFlowStep: 0.1,
      particleFlowTwist: 2.1,
      particleFlowBias: -0.28,
      particleFlowScale: 1.18,
      animationSpeed: 0.2,
      lineWidth: 2.6,
      lineColor: '#22d3ee',
      showTrail: true,
    ...
    {
      particleFlowDensity: 34,
      particleFlowStep: 0.18,
      particleFlowTwist: 0.82,
      particleFlowBias: 0.56,
      particleFlowScale: 1.25,
      animationSpeed: 0.22,
      lineWidth: 2.8,
      lineColor: '#6366f1',
      showTrail: true,
